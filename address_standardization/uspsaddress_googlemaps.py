...
To get Google Map key, https://developers.google.com/maps/documentation/geocoding/get-api-key
"""
...
class uspsaddress_googlemaps(object):
    ...
    geocoder_us_sleep = 0.1
    data_science_toolkit_sleep = 0.1

    """
    Pick a particular Google Maps API key to use and access the API
    """
    k = 0
    gmaps_keys = ['TODO',
                  'TODO',
    ...
    gmaps = googlemaps.Client(key=gmaps_keys[k])
    ...
    def map_googlemaps_result(self, result):
        ...
        for i in range(len(result[0]['address_components'])):
            if len(result[0]['address_components'][i]['types'])!=0:
                header2 = result[0]['address_components'][i]['types'][0]
            elif len(result[0]['address_components'][i]['types'])==0:
                header2 = ""
            if not header2 == None:
        ...
        for header2, value2 in result.iteritems():
            ...
            if not(header2 in ['']):
                if not header2 in self.headers_geocoder_us2usps.keys():
                    ...
                    #print "WARN: ", header2, " not in headers_geocoder_us2usps"
                    continue
                    ...
                    if v.upper() == elmt:
                        ...
                        if self.isverbose:
                            try:
                                ...
                                if self.isverbose:
                                    print >> self.log_file, "Not sure how to handle"
                            if self.isverbose:
    ...
    def googlemaps_parse_address_line(self, address_line="", wrong_counts={}, method=1):
        ...
        if len(result) == 0:
            ...
            if self.isverbose: print >> self.log_file, msg
        ...
        try:
            ...
            if 'error' in result.keys():
                if result['error'] == "2: couldn't find this address! sorry":
                    ...
                    if self.isverbose: print >> self.log_file, "ERROR: ", result['error'], 'to be added to wrong_counts'
            ...
            if self.isverbose: print >> self.log_file, "ERROR: timeout"
            wrong_counts['timeout'] += 1
            return ifsuccess, result, wrong_counts
    ...
    def perturb_address_line(self, address_line, g):
        r = random.random()
    ...
    def eval_googlemaps(self, n=20000, method=1, g=0, t=0):
        """
        ...
        ****1, 6.0, 0.0, 6.0, 0.0, 1.0
        ...
        inputfile = "samplefordatalinkage.csv"
        ...
        if self.isverbose:
            ...
            if g>0: print >> self.log_file, "error rate = ", g # self.error_rate
                ...
                if row_count <= n+t:
                    if row_count > t:
                        if self.isverbose:
                            print >> self.log_file, \
                                "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", row_count
                            total_right_count, total_wrong_count, wrong_counts, row2, ifscuccess = self.eval_googlemaps_row(
                                f, g, method,
    ...
    def eval_googlemaps_row(self, f, g, method, right_counts, row, row_count, total_right_count, total_wrong_count,
        ...
        # if g == 1:
        if g > 0:
            address_line = self.perturb_address_line(address_line, g)
    ...
    def eval_geocoder_us(self, n=20000, g=0, t=0):
        """
        162 PENDEXTER AVE CHICOPEE MA 01013 2126
        216 E HILL RD BRIMFIELD MA 01010 9799
        ...
        ****1, 6.0, 0.0, 6.0, 0.0, 1.0
        ...
        print "\n\n=================================================GeoCoder n = %s, g = %s, error_rate = %s" % (n,g,g) #self.error_rate
        if self.isverbose:
            print >> self.log_file, "\n\n=================================================GeoCoder n = %s, g = %s, error_rate = %s" % (n,g,g) #self.error_rate
        self.print_counts(wrong_counts, right_counts)
        self.print_total_counts(total_right_count, total_wrong_count)
    ...
    def eval_data_science_toolkit(self, n=20000, g=0, t=0):
        """
        162 PENDEXTER AVE CHICOPEE MA 01013 2126
        216 E HILL RD BRIMFIELD MA 01010 9799
        ...
        ****1, 6.0, 0.0, 6.0, 0.0, 1.0
        ...
        print "\n\n=================================================Data Science Toolkit n = %s, g = %s, error_rate = %s" % (n,g, g) #self.error_rate
        if self.isverbose: print >> self.log_file, "\n\n=================================================Data Science Toolkit n = %s, g = %s, error_rate = %s" % (n,g,g) #self.error_rate
        self.print_counts(wrong_counts, right_counts)
        self.print_total_counts(total_right_count, total_wrong_count)
    ...
    def usaddress_parse_address_line(self, address_line="", wrong_counts={}):
        ...
        try:
            ...
            if self.isverbose: print >> self.log_file, "ERROR: usaddress timeout"
            wrong_counts['timeout'] += 1
            return ifsuccess, result, wrong_counts
    ...
    def eval_usaddress(self, n=20000, g=0, t=0):
        """
        162 PENDEXTER AVE CHICOPEE MA 01013 2126
        216 E HILL RD BRIMFIELD MA 01010 9799
        ...
        ****1, 6.0, 0.0, 6.0, 0.0, 1.0
        ...
        print "\n\n=================================================US address n = %s, g = %s, error_rate = %s" % (n,g, g) # self.error_rate
        if self.isverbose: print >> self.log_file, "\n\n=================================================US address n = %s, g = %s, error_rate = %s" % (n,g, g) #self.error_rate
        self.print_counts(wrong_counts, right_counts)
        self.print_total_counts(total_right_count, total_wrong_count)
